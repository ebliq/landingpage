...
export default function Page() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-50% from-blue-950 to-fuchsia-900 py-12 px-4 rounded-lg shadow-md mt-8">
        <div className=" max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            {/* Box 1 */}
            <div className="bg-blue-900 p-6 rounded-lg shadow-md flex flex-col items-start text-left">
          ...
          <h1 className="font-semibold text-white mb-4 mt-12">
      ...
      <section className="py-20 px-4 rounded-lg">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <h1 className="text-4xl font-bold mb-6">
              ...
              <span className="text-blue-700">Daten schützen</span>
            </h1>
