...
export default function Page() {
  return (
    <section className="mx-auto w-full max-w-3xl px-4 lg:px-6">
      ...
      <Heading level={2}>Datenschutz-erklärung</Heading>
      <Heading level={3}>Datenschutz</Heading>
      <Paragraph>
      ...
      <Heading level={3}>Server-Log- Files</Heading>
      ...
      <Heading level={3}>SSL-Verschlüsselung</Heading>
      <Paragraph>
      ...
      <Heading level={3}>Recht auf Auskunft, Löschung, Sperrung</Heading>
      <Paragraph>
      ...
      <Heading level={3}>Widerspruch Werbe-Mails</Heading>
      <Paragraph>
