    ...
    <>
      <section className="px-4 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-4 text-lg">
            Nutzen Sie die Möglichkeit, Ebliq schon heute in Ihrer Praxis oder Ihrem Netzwerk zu testen. In unserem Early
            Access-Programm arbeiten wir eng mit ausgewählten Teams zusammen, um reale Workflows abzubilden, Rückmeldungen direkt
          ...
          <p className="mb-6 text-lg">
            ...
            Funktionen. Gleichzeitig sichern Sie sich einen Vorsprung, weil Sie Ihre Prozesse bereits optimiert haben, wenn Ebliq
            offiziell startet.
          </p>
      ...
      <section className="bg-gradient-to-br from-50% from-primary-900 to-secondary-900 px-4 py-12 text-white shadow-md">
        <div className="container mx-auto">
          <h2 className="mb-12 text-center text-3xl font-bold">Was Early Access für Sie bedeutet</h2>
          <div className="flex flex-wrap justify-center gap-8">
            <div className="w-full rounded-sm bg-primary/10 p-8 text-center text-white shadow-md sm:w-1/2 lg:w-1/3">
              ...
              <h3 className="mb-2 text-xl font-semibold">Direktes Feedback, echte Wirkung</h3>
              <p>
            ...
            <div className="w-full rounded-sm bg-primary/10 p-8 text-center text-white shadow-md sm:w-1/2 lg:w-1/3">
              <CheckCircle2 className="mx-auto mb-4 h-12 w-12 text-green-300" />
              <h3 className="mb-2 text-xl font-semibold">Persönliche Einführung & Support</h3>
              <p>
            ...
            <div className="w-full rounded-sm bg-primary/10 p-8 text-center text-white shadow-md sm:w-1/2 lg:w-1/3">
              <CheckCircle2 className="mx-auto mb-4 h-12 w-12 text-green-300" />
              <h3 className="mb-2 text-xl font-semibold">Exklusive Vorteile für Pionier:innen</h3>
              <p>
          ...
          <div className="space-y-4">
            <details className="group rounded-md border border-blue-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-4 space-y-2 text-base text-gray-700">
                <p>
                  Wir lernen Ihr Team kennen, definieren gemeinsam Ziele und stimmen ab, welche Use Cases in der Early
                  Access-Phase im Fokus stehen sollen.
                </p>
              </div>
            </details>
            <details className="group rounded-md border border-blue-200 bg-white p-4 shadow-sm">
              <summary className="flex cursor-pointer items-center justify-between text-left text-lg font-semibold text-blue-900">
                2. Roll-out in Ihrem Alltag
                <span className="text-blue-900 transition-transform duration-300 group-open:rotate-180">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                    <path
                      fillRule="evenodd"
              ...
              <div className="mt-4 space-y-2 text-base text-gray-700">
                <p>
                  Gemeinsam richten wir Ebliq für Ihr Team ein, schulen Mitarbeitende und begleiten die ersten Einsätze, damit
                  alle sicher und souverän mit den KI-Agenten arbeiten können.
                </p>
              </div>
            </details>
            <details className="group rounded-md border border-blue-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-4 space-y-2 text-base text-gray-700">
                <p>
                  Wir sammeln strukturiert Feedback, priorisieren Verbesserungen und vereinbaren im Abschlussgespräch, wie die
                  Zusammenarbeit nach der Early Access-Phase weitergeht.
                </p>
              </div>
            </details>
          </div>
