...
export default () => (
  <Layout>
    ...
    <p>
      Beim Aufrufen dieser Website werden durch den auf Ihrem Endgerät zum Einsatz kommenden Browser automatisch
    ...
    <p>
      Die Möglichkeit, diese Daten auf der Rechtsgrundlage nach Art. 6 Abs. 1 S. 1 lit. f DSGVO für Zwecke wie die
      Gewährleistung eines reibungslosen Verbindungsaufbaus der Website, die Gewährleistung einer komfortablen Nutzung
      unserer Website, die Auswertung der Systemsicherheit und -stabilität sowie zu weiteren administrativen Zwecken zu
      nutzen, wird derzeit von uns nicht wahrgenommen. Sollten wir diese Möglichkeit künftig nutzen wollen, werden wir
      die erhobenen Daten in keinem Fall dafür verwenden, Rückschlüsse auf Ihre Person zu ziehen.
    </p>
    ...
    <p>
      ...
      Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit
